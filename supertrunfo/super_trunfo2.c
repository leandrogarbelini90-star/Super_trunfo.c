#include <stdio.h>
  int main(){
    ...
    float densidade_populacional = populacao1 / area_total1;
    float PIB_per_Capita = PIB1 / area_total1;
    ...
    float densidade_populaciona2 = populacao2 / area_total2;
    float PIB_per_Capita2 = PIB2 / area_total2;
